...
- 主站: https://github.com/vodtv/hosts
- 镜像: https://gitlab.com/vodtv/hosts
- Github Pages: https://vodtv.github.io/hosts/
...
```bash
curl -L https://github.com/vodtv/raw/releases/download/v1.0.1/hosts-server-pkg-mac-x64.tar.gz | tar xzvf -
...
```bash
curl -L https://github.com/vodtv/raw/releases/download/v1.0.1/hosts-server-pkg-mac-arm64.tar.gz | tar xzvf -
...
```bash
curl -L https://github.com/vodtv/raw/releases/download/v1.0.1/hosts-server-pkg-linuxstatic-x64.tar.gz | tar xzvf -
...
```bash
curl -L https://github.com/vodtv/raw/releases/download/v1.0.1/hosts-server-pkg-linuxstatic-arm64.tar.gz | tar xzvf -
...
```bash
curl -L https://github.com/vodtv/raw/releases/download/v1.0.1/hosts-server-pkg-linuxstatic-armv7.tar.gz | tar xzvf -
./hosts-server-pkg-linuxstatic-armv7/hosts-server --port=8888
```

### Windows

下载 https://github.com/vodtv/raw/releases/download/v1.0.1/hosts-server-pkg-win-x64.zip ，解压后执行下面命令，服务会运行在： http://localhost:8888
...
详细介绍可以阅读 [SwitchHosts! 还能这样管理 hosts，后悔没早点用](https://mp.weixin.qq.com/s/A37XnD3HdcGSWUflj6JujQ) 。
...
- 方案名：GitHub（可以自行命名）
- 类型：远程
- URL 地址：https://gitlab.com/vodtv/raw/-/raw/main/hosts
- 自动更新：1 个小时（时间可自行调整）
